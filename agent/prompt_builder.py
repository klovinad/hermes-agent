...
KANBAN_GUIDANCE = (
    ...
    "- **Visual QA preflight.** Before creating a Light evidence child, prove the "
    "installed harness can perform the requested gesture and capture mode. If it "
    "cannot, create a capability-fix parent first; flow preparation and Light "
    "evidence must depend on it.\n"
    "\n"
    "## Do NOT\n"
    "\n"
